 ...
 * the lightweight SPV mode, a {@link com.nhnsoft.bitcoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.nhnsoft.bitcoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
