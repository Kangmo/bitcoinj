...
import com.nhnsoft.bitcoin.crypto.DRMWorkaround;
import com.nhnsoft.bitcoin.net.BlockingClientManager;
import com.nhnsoft.bitcoin.net.ClientConnectionManager;
import com.nhnsoft.bitcoin.net.FilterMerger;
import com.nhnsoft.bitcoin.net.NioClientManager;
import com.nhnsoft.bitcoin.net.discovery.PeerDiscovery;
import com.nhnsoft.bitcoin.net.discovery.PeerDiscoveryException;
import com.nhnsoft.bitcoin.net.discovery.TorDiscovery;
import com.nhnsoft.bitcoin.script.Script;
import com.nhnsoft.bitcoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.nhnsoft.bitcoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.nhnsoft.bitcoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.nhnsoft.bitcoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.nhnsoft.bitcoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.nhnsoft.bitcoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.nhnsoft.bitcoin.core.Peer#ping()}.
     */
