...
import com.nhnsoft.bitcoin.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link com.nhnsoft.bitcoin.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link com.nhnsoft.bitcoin.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
