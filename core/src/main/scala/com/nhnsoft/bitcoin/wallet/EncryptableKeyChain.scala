...
trait EncryptableKeyChain extends KeyChain {
     ...
     * {@link com.nhnsoft.bitcoin.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.nhnsoft.bitcoin.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
