...
import com.nhnsoft.bitcoin.params.*;
import com.nhnsoft.bitcoin.script.Script;
import com.nhnsoft.bitcoin.script.ScriptOpCodes;
...
public abstract class NetworkParameters implements Serializable {
    ...
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.nhnsoft.bitcoin.unittest";
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.nhnsoft.bitcoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.nhnsoft.bitcoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.nhnsoft.bitcoin.core.AlertMessage}s. You can use {@link com.nhnsoft.bitcoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
