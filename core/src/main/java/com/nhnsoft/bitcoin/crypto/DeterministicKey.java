...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link com.nhnsoft.bitcoin.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link com.nhnsoft.bitcoin.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
