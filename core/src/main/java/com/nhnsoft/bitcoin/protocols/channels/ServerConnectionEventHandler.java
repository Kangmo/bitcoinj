...
public abstract class ServerConnectionEventHandler {
     ...
     * {@link StoredPaymentChannelServerStates#getChannel(com.nhnsoft.bitcoin.core.Sha256Hash)} with the id provided in
     * {@link ServerConnectionEventHandler#channelOpen(com.nhnsoft.bitcoin.core.Sha256Hash)}</p>
     */
