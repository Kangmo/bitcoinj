...
import com.nhnsoft.bitcoin.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.nhnsoft.bitcoin.core.Wallet.SendRequest)}.
