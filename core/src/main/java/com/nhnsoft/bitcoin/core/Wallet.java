...
import com.nhnsoft.bitcoin.core.TransactionConfidence.ConfidenceType;
import com.nhnsoft.bitcoin.crypto.*;
import com.nhnsoft.bitcoin.params.UnitTestParams;
import com.nhnsoft.bitcoin.script.Script;
import com.nhnsoft.bitcoin.script.ScriptBuilder;
import com.nhnsoft.bitcoin.script.ScriptChunk;
import com.nhnsoft.bitcoin.signers.DummySigSigner;
import com.nhnsoft.bitcoin.signers.LocalTransactionSigner;
import com.nhnsoft.bitcoin.signers.TransactionSigner;
import com.nhnsoft.bitcoin.store.UnreadableWalletException;
import com.nhnsoft.bitcoin.store.WalletProtobufSerializer;
import com.nhnsoft.bitcoin.utils.BaseTaggableObject;
import com.nhnsoft.bitcoin.utils.ExchangeRate;
import com.nhnsoft.bitcoin.utils.ListenerRegistration;
import com.nhnsoft.bitcoin.utils.Threading;
import com.nhnsoft.bitcoin.wallet.*;
import com.nhnsoft.bitcoin.wallet.WalletTransaction.Pool;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.nhnsoft.bitcoin.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag {
     ...
     * {@link com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)} with
     * {@link com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.nhnsoft.bitcoin.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.nhnsoft.bitcoin.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.nhnsoft.bitcoin.crypto.KeyCrypter,
     ...
     * {@link com.nhnsoft.bitcoin.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link com.nhnsoft.bitcoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.nhnsoft.bitcoin.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.nhnsoft.bitcoin.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.nhnsoft.bitcoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
         ...
         * replaced with dummy signature ({@link com.nhnsoft.bitcoin.crypto.TransactionSignature#dummy() }). This is
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.nhnsoft.bitcoin.core.TransactionBroadcaster broadcaster) {
     ...
     * {@link com.nhnsoft.bitcoin.core.PeerFilterProvider} interface and generally should not be used directly by apps.
