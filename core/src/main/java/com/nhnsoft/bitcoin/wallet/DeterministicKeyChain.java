...
import com.nhnsoft.bitcoin.core.BloomFilter;
import com.nhnsoft.bitcoin.core.ECKey;
import com.nhnsoft.bitcoin.core.Utils;
 ...
 * {@link com.nhnsoft.bitcoin.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.nhnsoft.bitcoin.crypto.MnemonicCode},
 ...
 * {@link com.nhnsoft.bitcoin.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.nhnsoft.bitcoin.crypto.DeterministicKey#deserializeB58(com.nhnsoft.bitcoin.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.nhnsoft.bitcoin.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.nhnsoft.bitcoin.crypto.DeterministicHierarchy} and
 * {@link com.nhnsoft.bitcoin.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.nhnsoft.bitcoin.crypto.DeterministicKey)}
