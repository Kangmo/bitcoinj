 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.nhnsoft.bitcoin.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link com.nhnsoft.bitcoin.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence implements Serializable {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.nhnsoft.bitcoin.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        public enum ChangeReason {
            /**
             * Occurs when the type returned by {@link com.nhnsoft.bitcoin.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link com.nhnsoft.bitcoin.wallet.CoinSelector} implementations to risk analyze
