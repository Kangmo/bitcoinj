 ...
 * {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain}. The purpose of this wrapper is to simplify the encryption
 * code.
 */
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.nhnsoft.bitcoin.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.nhnsoft.bitcoin.crypto.MnemonicException if check fails
     */
