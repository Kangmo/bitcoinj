...
import com.nhnsoft.bitcoin.crypto.KeyCrypter;
...
/**
 * <p>A KeyChainGroup is used by the {@link com.nhnsoft.bitcoin.core.Wallet} and
 * manages: a {@link com.nhnsoft.bitcoin.wallet.BasicKeyChain} object (which will normally be empty), and zero or more
 * {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain}s. A deterministic key chain will be created lazily/on demand
 ...
 * class docs for {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain} for more information on this topic.</p>
 */
public class KeyChainGroup implements KeyBag {
     ...
     * For married keychains use {@link #currentAddress(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)}
     ...
     * <p>This method is not supposed to be used for married keychains and will throw UnsupportedOperationException if
     * the active chain is married.
     * For married keychains use {@link #freshAddress(com.nhnsoft.bitcoin.wallet.KeyChain.KeyPurpose)}
     * to get a proper P2SH address</p>
     */
     ...
     * see {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain#setLookaheadSize(int)}
     ...
     * {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain#setLookaheadSize(int)}
     * for more information.
     */
     ...
     * {@link com.nhnsoft.bitcoin.wallet.DeterministicKeyChain#setLookaheadThreshold(int)}
     * for more information.
     */
     ...
     *
     * @throws com.nhnsoft.bitcoin.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.nhnsoft.bitcoin.crypto.KeyCrypterScrypt}.
     *
     * @throws com.nhnsoft.bitcoin.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
     ...
     * @throws com.nhnsoft.bitcoin.wallet.DeterministicUpgradeRequiresPassword if the key chain group is encrypted
