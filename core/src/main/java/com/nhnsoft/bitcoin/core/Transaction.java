...
import static com.nhnsoft.bitcoin.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.nhnsoft.bitcoin.script.Script, ECKey, com.nhnsoft.bitcoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.nhnsoft.bitcoin.core.Transaction.SigHash, boolean)}
