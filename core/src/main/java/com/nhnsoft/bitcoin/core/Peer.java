 ...
 * {@link com.nhnsoft.bitcoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.nhnsoft.bitcoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.nhnsoft.bitcoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.nhnsoft.bitcoin.net.StreamParser)}
     * or
     * {@link com.nhnsoft.bitcoin.net.NioClient#NioClient(java.net.SocketAddress, com.nhnsoft.bitcoin.net.StreamParser, int)}.</p>
     *
   ...
   /**
     ...
     * Once the pong is received the value returned by {@link com.nhnsoft.bitcoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.nhnsoft.bitcoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.nhnsoft.bitcoin.core.Peer#ping()} has never
