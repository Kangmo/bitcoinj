...
import com.nhnsoft.bitcoin.net.AbstractTimeoutHandler;
import com.nhnsoft.bitcoin.net.MessageWriteTarget;
import com.nhnsoft.bitcoin.net.StreamParser;
 ...
 * {@link com.nhnsoft.bitcoin.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.nhnsoft.bitcoin.net.NioClient} or
     * {@link com.nhnsoft.bitcoin.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
